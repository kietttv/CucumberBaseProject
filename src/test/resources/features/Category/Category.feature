Feature: Manage Category
  ...
  Scenario Outline: Add new category
    ...
    Examples:
      | name            | parent | ordering number | type | banner | icon | meta title                 | meta description                 | filter attibutes | message                                             |
      | ""              | ""     | "1"             | ""   | ""     | ""   | "Test category meta title" | "Test category meta description" | ""               | "https://cms.anhtester.com/admin/categories/create" |
      | "Test category" | ""     | "0"             | ""   | ""     | ""   | "Test category meta title" | "Test category meta description" | ""               | "https://cms.anhtester.com/admin/categories/create" |
      | "Test category" | ""     | "-1"            | ""   | ""     | ""   | "Test category meta title" | "Test category meta description" | ""               | "https://cms.anhtester.com/admin/categories/create" |
